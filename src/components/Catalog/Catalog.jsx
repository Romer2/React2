        ...
        <section className={`container ${s.catalog}`}>
            ...
            <div className={s.cat}>
                ...
                <div className={s.btns}>
                    <buttton className={s.btn}>Все товары</buttton>
                    <buttton className={s.btn}>Шины/колеса</buttton>
                    <buttton className={s.btn}>Масла</buttton>
                    <buttton className={s.btn}>Ароматизаторы</buttton>
                </div>
            </div>
